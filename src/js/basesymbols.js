...
Link.prototype.draw = function () {
    ...
    document.addEventListener('portmouseenter', this.__listeners__.portmouseenter);
    document.addEventListener('portmouseleave', this.__listeners__.portmouseleave);
};
...
Link.prototype.onMouseUp = function (evt) {
    ...
    document.removeEventListener('portmouseenter', this.__listeners__.portmouseenter);
    document.removeEventListener('portmouseleave', this.__listeners__.portmouseleave);
